  ...
  <div @click="handleClick">
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        ></path>
        <ellipse fill="#664500" cx="11.5" cy="16.5" rx="2.5" ry="3.5"></ellipse>
        <ellipse fill="#664500" cx="24.5" cy="16.5" rx="2.5" ry="3.5"></ellipse>
        <path
          fill="#664500"
        ...
        <path
          fill="#5DADEC"
          d="M10 30c0 2.762-2.238 5-5 5s-5-2.238-5-5s4-10 5-10s5 7.238 5 10z"
        ></path>
        <path
          fill="#664500"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <path
          ...
          d="M36 18c0 9.941-8.059 18-18 18c-9.94 0-18-8.059-18-18C0 8.06 8.06 0 18 0c9.941 0 18 8.06 18 18"
        ></path>
        <ellipse fill="#5eead4" cx="11.5" cy="16.5" rx="2.5" ry="3.5"></ellipse>
        <ellipse fill="#5eead4" cx="24.5" cy="16.5" rx="2.5" ry="3.5"></ellipse>
        <path
          fill="#5eead4"
          d="M23.485 27.879C23.474 27.835 22.34 23.5 18 23.5s-5.474 4.335-5.485 4.379a.496.496 0 0 0 .232.544a.51.51 0 0 0 .596-.06c.009-.007 1.013-.863 4.657-.863c3.59 0 4.617.83 4.656.863a.496.496 0 0 0 .59.073a.5.5 0 0 0 .239-.557z"
        ></path>
